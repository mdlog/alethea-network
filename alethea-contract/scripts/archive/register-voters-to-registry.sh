...
linera request-application $CHAIN_ID $ALETHEA_REGISTRY_ID registerVoter \
  --json-argument "{\"voter_app\": \"$VOTER_1_ID\", \"initial_stake\": \"1000\"}"

# Register Voter 2
echo "Registering Voter 2: $VOTER_2_ID"
linera request-application $CHAIN_ID $ALETHEA_REGISTRY_ID registerVoter \
  --json-argument "{\"voter_app\": \"$VOTER_2_ID\", \"initial_stake\": \"1000\"}"

# Register Voter 3
echo "Registering Voter 3: $VOTER_3_ID"
linera request-application $CHAIN_ID $ALETHEA_REGISTRY_ID registerVoter \
  --json-argument "{\"voter_app\": \"$VOTER_3_ID\", \"initial_stake\": \"1000\"}"
