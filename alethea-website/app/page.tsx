   ...
   with Reputation
                        ...
                        >
                            <motion.a
                                ...
                                target="_blank"
                                className="gr12 py-6 rounded-2xl text-xl font-bold transition-all flex items-center justify-center gap-3 shadow-2xl shadow-cyan-500/30 hover:shadow-cyan-500/50 overflow-hidden min-w-[280px]"
                                whileHover={{ scale: 1.05, y: -3 }}
                                whileTap={{ scale: 0.98 }}
                            >
                                <span className="relative z-10">Launch Explorer</span>
                                <ArrowRight className="w-6 h-6 group-hover:tra-transform relative z-10" />
