    ...
    return (
        <div className="card p-6">
            <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                    <h3 className="font-semibold text-black">Pending Rewards</h3>
                    <p className="text-sm text-grey-600">Claim your voting rewards</p>
                </div>
            </div>
            ...
            <button
                ...
                className={`w-full py-3 px-4 rounded-lg font-medium flex items-center justify-center gap-2 transition-all ${hasPendingRewards && !claiming && isWasmReady
