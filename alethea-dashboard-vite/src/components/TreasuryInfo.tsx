        ...
        return (
            <div className="card p-6">
                <div className="flex items-center justify-center py-8">
                    <Loader2 className="w-6 h-6 animate-spin text-alethea-500" />
                </div>
            </div>
        );
    }
        ...
        <div className="card overflow-hidden">
            <div className="p-4 border-b border-grey-100 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-semibold text-black">Protocol Treasury</h3>
                        <p className="text-sm text-grey-600">Network financial overview</p>
                    </div>
                </div>
                <button
                    onClick={loadStats}
                ...
                >
                    <RefreshCw className="w-4 h-4 text-grey-600" />
                </button>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-grey-100">
                <div className="p-4">
                ...
                <div className="p-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs text-grey-600">Reward Pool</span>
                    </div>
                    <p className="text-xl font-bold text-black">
                ...
                <div className="p-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs text-grey-600">Distributed</span>
                    </div>
                    <p className="text-xl font-bold text-black">
                ...
                <div className="p-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs text-grey-600">Total Staked</span>
                    </div>
                    <p className="text-xl font-bold text-black">
